...
/**
 * Adapter for AllAppointments of FamilyMember RecyclerView
 */
class FamilyMemberAppointmentAdapter(private val onAppointmentClicked: (Appointment) -> Unit) :
    ListAdapter<Appointment, FamilyMemberAppointmentAdapter.AllAppointmentsViewHolder>(DiffCallback) {
    ...
    class AllAppointmentsViewHolder(private val view: View) : RecyclerView.ViewHolder(view){
        ...
        fun bind(appointment: Appointment){
            ...
            binding.tvFamilyMember.text = appointment.familyMemberName.toString()
        }
